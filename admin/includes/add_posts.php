<form action="" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="post_image" class="form-control" id="" aria-describedby="" placeholder="Enter post image">
  </div>
  ...
  <div class="form-group">
    ...
    <textarea name="post_content" class="form-control" id="" rows="5" aria-describedby="" placeholder="Enter post content"></textarea>
  </div>
